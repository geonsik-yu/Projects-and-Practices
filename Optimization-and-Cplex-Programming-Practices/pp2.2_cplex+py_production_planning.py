"""
 Title: Profit Maximization Problem for Production Planning in Automobile Industry
 Note:
	...
	- Unit costs of vehicle body and painting are not considered in the spreadsheet (= 0).
...
def main(argv=None):
	read_info = read_input("./input/pp2.2_production_planning.xlsx")
